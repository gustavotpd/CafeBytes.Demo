...
extern void *mono_aot_module_CafeBytesDemoiOS_info;
extern void *mono_aot_module_monotouch_info;
extern void *mono_aot_module_mscorlib_info;

void monotouch_register_modules ()
{
	mono_aot_register_module (mono_aot_module_CafeBytesDemoiOS_info);
...
void monotouch_setup ()
{
	...
	monotouch_assembly_name = "CafeBytesDemoiOS.exe";
	mono_use_llvm = FALSE;
