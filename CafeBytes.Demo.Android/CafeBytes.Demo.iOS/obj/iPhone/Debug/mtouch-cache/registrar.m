...
@implementation AppDelegate { } 
	...
	-(id) window
	{
		...
		return native_to_managed_trampoline_1 (self, _cmd, &managed_method, "CafeBytes.Demo.iOS.AppDelegate, CafeBytesDemoiOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "get_Window");
	}

	-(void) setWindow:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIWindow, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "CafeBytes.Demo.iOS.AppDelegate, CafeBytesDemoiOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "set_Window");
	}

	-(void) applicationWillResignActive:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIApplication, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "CafeBytes.Demo.iOS.AppDelegate, CafeBytesDemoiOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "OnResignActivation");
	}

	-(void) applicationDidEnterBackground:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIApplication, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "CafeBytes.Demo.iOS.AppDelegate, CafeBytesDemoiOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "DidEnterBackground");
	}

	-(void) applicationWillEnterForeground:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIApplication, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "CafeBytes.Demo.iOS.AppDelegate, CafeBytesDemoiOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "WillEnterForeground");
	}

	-(void) applicationWillTerminate:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIApplication, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "CafeBytes.Demo.iOS.AppDelegate, CafeBytesDemoiOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "WillTerminate");
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_4 (self, _cmd, &managed_method, "CafeBytes.Demo.iOS.AppDelegate, CafeBytesDemoiOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", ".ctor");
	}
@end

@interface CafeBytes_Demo_iOSViewController : UIViewController {
	int __monoObjectGCHandle;
}
	-(void) release;
	-(id) retain;
	...
	-(bool) conformsToProtocol:(void *)p0;
@end
@implementation CafeBytes_Demo_iOSViewController { } 
	-(void) release
	{
		monotouch_release_trampoline (self, _cmd);
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_5 (self, _cmd, &managed_method, "CafeBytes.Demo.iOS.CafeBytes_Demo_iOSViewController, CafeBytesDemoiOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "DidReceiveMemoryWarning");
	}

	-(void) viewDidLoad
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_5 (self, _cmd, &managed_method, "CafeBytes.Demo.iOS.CafeBytes_Demo_iOSViewController, CafeBytesDemoiOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewDidLoad");
	}

	-(void) viewWillAppear:(bool)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "CafeBytes.Demo.iOS.CafeBytes_Demo_iOSViewController, CafeBytesDemoiOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewWillAppear");
	}

	-(void) viewDidAppear:(bool)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "CafeBytes.Demo.iOS.CafeBytes_Demo_iOSViewController, CafeBytesDemoiOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewDidAppear");
	}

	-(void) viewWillDisappear:(bool)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "CafeBytes.Demo.iOS.CafeBytes_Demo_iOSViewController, CafeBytesDemoiOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewWillDisappear");
	}

	-(void) viewDidDisappear:(bool)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "CafeBytes.Demo.iOS.CafeBytes_Demo_iOSViewController, CafeBytesDemoiOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewDidDisappear");
	}
...
@end
	...
	static MTClassMap __monotouch_class_map [] = {
		...
		{"AppDelegate", "CafeBytes.Demo.iOS.AppDelegate, CafeBytesDemoiOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", NULL },
		...
		{"CafeBytes_Demo_iOSViewController", "CafeBytes.Demo.iOS.CafeBytes_Demo_iOSViewController, CafeBytesDemoiOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", NULL },
...
void monotouch_create_classes () {
	...
	__monotouch_class_map [4].handle = [CafeBytes_Demo_iOSViewController class];
	__monotouch_class_map [5].handle = objc_getClass ("NSArray");
	__monotouch_class_map [6].handle = objc_getClass ("NSString");
	__monotouch_class_map [7].handle = objc_getClass ("UIApplication");
	...
	__monotouch_class_map [11].handle = objc_getClass ("__NSObject_Disposer");
	monotouch_setup_classmap (__monotouch_class_map, 12);
}
